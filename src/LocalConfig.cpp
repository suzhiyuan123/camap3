...
********************************************************************/  
void LocalConfig::GetCompletePath(char *pszConfigFileName, char *pszWholePath)
{
...
* 20150522       V1.0     Zhou Zhaoxiong     创建
********************************************************************/
void LocalConfig::GetStringContentValue(FILE *fp, char *pszSectionName, char *pszKeyName, char *pszOutput, UINT32 iOutputLen)
{
...
* 20150522       V1.0     Zhou Zhaoxiong     创建
********************************************************************/  
void LocalConfig::GetConfigFileStringValue(char *pszSectionName, char *pszKeyName, char *pDefaultVal, char *pszOutput, UINT32 iOutputLen, char *pszConfigFileName)
{
    FILE  *fp                    = NULL;
    char  szWholePath[256]      = {0};
...
void LocalConfig::ReadGlobalParam(Gloabl_Param *gParam){
	return UpdateGlobalParam(gParam);
}

void LocalConfig::WriteGlobalConfig(Gloabl_Param *gParam){
